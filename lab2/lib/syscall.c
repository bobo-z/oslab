            ...
            case 1:
                switch(format[i])
                {
                    case 'd':
                        state = 0;
                        index += 4;
                        count = dec2Str(*(int*)(paraList+index), buffer, MAX_BUFFER_SIZE, count);
                        break;

                    case 'x':
                        state = 0;
                        index += 4;
                        count = hex2Str(*(uint32_t*)(paraList+index), buffer, MAX_BUFFER_SIZE, count);
                        break;
                    case 's':
                        state = 0;
                        index += 4;
                    ...
                    case 'c':
                        state = 0;
                        index += 4;
                        buffer[count] = *(char*)(paraList+index);
                        count++;
                        break;
                    default:
                        buffer[count]=format[i];
